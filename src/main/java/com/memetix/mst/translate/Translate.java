...
public final class Translate extends MicrosoftTranslatorAPI {
    ...
    public String execute(final String text, final Language from, final Language to) throws Exception {
        ...
        final String params = PARAM_FROM_LANG + URLEncoder.encode(from.toString(), ENCODING)
     ...
     * @throws Exception on error.
     */
    public String execute(final String text, final Language to) throws Exception {
     ...
     * @throws Exception on error.
     */
    public String[] execute(final String[] texts, final Language from, final Language to) throws Exception {
        //Run the basic service validations first
     ...
     * @throws Exception on error.
     */
    public String[] execute(final String[] texts, final Language to) throws Exception {
