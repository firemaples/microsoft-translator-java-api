...
public final class BreakSentences extends MicrosoftTranslatorAPI {
    ...
    public BreakSentences(String subscriptionKey) {
     ...
     */
    public Integer[] execute(final String text, final Language fromLang) throws Exception {
    ...
    private void validateServiceState(final String text, final Language fromLang) throws Exception {
