...
public final class Detect extends MicrosoftTranslatorAPI {
    ...
    public Detect(String subscriptionKey) {
     ...
     */
    public Language execute(final String text) throws Exception {
     ...
     * @throws Exception on error.
     */
    public String[] execute(final String[] texts) throws Exception {
        //Run the basic service validations first
