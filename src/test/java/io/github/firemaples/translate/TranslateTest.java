...
//    }
    ...
    @Test
    public void testTranslate_EnglisthToChineseTraditional_Unicode() throws Exception {
        assertEquals("測試", Translate.execute("test", Language.ENGLISH, Language.CANTONESE_TRADITIONAL));
    }

    @Test
    public void testTranslate_UsingSSL_EnglisthToChineseTraditional_Unicode() throws Exception {
        Translate.setUsingSSL(true);
        assertTrue(Translate.isUsingSSL());
        testTranslate_EnglisthToChineseTraditional_Unicode();
        Translate.setUsingSSL(false);
        assertFalse(Translate.isUsingSSL());
    }
    ...
    */
    ...
    @Test
    public void testTranslateArray_UsingSSL() throws Exception {
        Translate.setUsingSSL(true);
        assertTrue(Translate.isUsingSSL());
        testTranslateArray();
        Translate.setUsingSSL(false);
